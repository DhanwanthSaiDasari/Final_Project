...
preprocessor = pickle.load(open('final_preprocessor.pkl', 'rb'))
# Load the dataset
...
def main():
    ...
    telecommuting = change(st.selectbox("Telecommuting", ['No','Yes']))
    has_company_logo = change(st.selectbox("Has Company Logo", ['No','Yes']))
    has_questions = change(st.selectbox("Has Questions", ['No','Yes']))
